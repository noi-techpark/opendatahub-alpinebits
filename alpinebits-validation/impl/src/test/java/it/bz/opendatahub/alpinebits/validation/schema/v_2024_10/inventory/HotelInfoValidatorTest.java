...
public class HotelInfoValidatorTest {
    ...
    @Test
    public void testValidate_ShouldPass_WhenAlpineBitsHotelAmenityCodeIsValid() {
        String code = AlpineBitsCodeHotelAmenityType.AGREEMENT_WITH_GOLF_COURSE.getCode();
        ...
        validator.validate(hotelInfoType, null, VALIDATION_PATH);
    }
