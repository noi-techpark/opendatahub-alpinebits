...
public class InventoriesValidatorTest {
    ...
    public void testValidate_ShouldThrow_WhenClosingSeasonElement_AndClosingSeasonNotSupported() {
        ...
        validateAndAssert(
                ...
                ErrorMessage.EXPECT_HOTEL_INV_COUNT_NOTIF_SUPPORT_FOR_CLOSING_SEASONS
        );
    }
    ...
    public void testValidate_ShouldThrow_WhenClosingSeasonElement_AndClosingSeasonElementNotOnTopOfList() {
        ...
        validateAndAssert(
                ...
                VALIDATION_PATH,
                ValidationException.class,
                ErrorMessage.EXPECT_CLOSING_SEASON_TO_BE_ON_TOP_OF_LIST
        );
    }
    ...
    public void testValidate_ShouldThrow_WhenOutOfOrderUnsupportedAndHasOutOfOrder() {
        ...
        validateAndAssert(
                ...
                VALIDATION_PATH,
                ValidationException.class,
                ErrorMessage.EXPECT_HOTEL_INV_COUNT_NOTIF_SUPPORT_FOR_OUT_OF_ORDER
        );
    }
    ...
    public void testValidate_ShouldThrow_WhenOutOfMarketUnsupportedAndHasOutOfMarket() {
        ...
        validateAndAssert(
                ...
                VALIDATION_PATH,
                ValidationException.class,
                ErrorMessage.EXPECT_HOTEL_INV_COUNT_NOTIF_SUPPORT_FOR_OUT_OF_MARKET
        );
    }
    ...
    public void testValidate_ShouldThrow_OnUnknownCountType() {
        ...
        validateAndAssert(
                ...
                VALIDATION_PATH,
                ValidationException.class,
                ErrorMessage.EXPECT_COUNT_TYPE_TO_BE_ONE_OF_2_6_9
        );
    }
