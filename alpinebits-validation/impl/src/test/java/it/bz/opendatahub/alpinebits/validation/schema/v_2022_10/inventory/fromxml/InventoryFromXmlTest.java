...
package it.bz.opendatahub.alpinebits.validation.schema.v_2022_10.inventory.fromxml;
...
import it.bz.opendatahub.alpinebits.validation.schema.v_2022_10.inventory.OTAHotelDescriptiveContentNotifRQValidator;
...
public class InventoryFromXmlTest {
    ...
    private final Schema xsdSchema = XmlValidationSchemaProvider.buildXsdSchemaForAlpineBitsVersion("2022-10");
    private final Schema rngSchema = XmlValidationSchemaProvider.buildRngSchemaForAlpineBitsVersion("2022-10");
    ...
    public void testXml(String xmlFile, String action, XmlSchemaType xmlSchemaType, Class<Exception> exceptionClass) {
        String filename = "examples/v_2022_10/inventory/" + xmlFile;
