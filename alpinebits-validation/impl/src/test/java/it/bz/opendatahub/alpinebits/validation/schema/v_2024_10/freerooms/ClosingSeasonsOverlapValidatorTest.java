...
public class ClosingSeasonsOverlapValidatorTest {
    ...
    public void testValidate_ShouldThrow_WhenClosingSeasonsOverlap() {
        ...
        ClosingSeasonsOverlapPeriod p1 = new ClosingSeasonsOverlapPeriod("2024-01-01", "2024-01-04");
        ClosingSeasonsOverlapPeriod p2 = new ClosingSeasonsOverlapPeriod("2024-01-04", "2024-01-10");
        ClosingSeasonsOverlapPeriod p3 = new ClosingSeasonsOverlapPeriod("2024-01-02", "2024-01-06");
        ClosingSeasonsOverlapPeriod p4 = new ClosingSeasonsOverlapPeriod("2024-02-07", "2024-02-14");
    ...
    public void testValidate_ShouldAcceptNonOverlappingPeriods() {
        ClosingSeasonsOverlapPeriod p1 = new ClosingSeasonsOverlapPeriod("2024-01-01", "2024-01-04");
        ClosingSeasonsOverlapPeriod p2 = new ClosingSeasonsOverlapPeriod("2024-01-04", "2024-01-06");
        ClosingSeasonsOverlapPeriod p3 = new ClosingSeasonsOverlapPeriod("2024-02-07", "2024-02-14");
        ClosingSeasonsOverlapPeriod p4 = new ClosingSeasonsOverlapPeriod("2024-08-01", "2024-08-21");
        BaseInvCountType inventory1 = this.buildValidInventoryForClosingSeason(p1);
        BaseInvCountType inventory2 = this.buildValidInventoryForClosingSeason(p2);
        BaseInvCountType inventory3 = this.buildValidInventoryForClosingSeason(p3);
        BaseInvCountType inventory4 = this.buildValidInventoryForClosingSeason(p4);
