...
package it.bz.opendatahub.alpinebits.validation.schema.v_2022_10.freerooms.fromxml;
...
import it.bz.opendatahub.alpinebits.validation.schema.v_2022_10.freerooms.OTAHotelInvCountNotifRQValidator;
...
public class FreeRoomsFromXmlTest {
    ...
    public void testXml(String xmlFile, HotelInvCountNotifContext ctx, XmlSchemaType xmlSchemaType, Class<Exception> exceptionClass) {
        String filename = "examples/v_2022_10/freerooms/" + xmlFile;
