...
/**
 * Use this validator to validate the UniqueID in AlpineBits 2024
 * FreeRooms documents.
 *
 * @see UniqueIDType
 */
public class UniqueIDValidator implements Validator<UniqueIDType, Boolean> {
    ...
    private static final Validator<UniqueIDType, Boolean> VALIDATION_DELEGATE =
            new it.bz.opendatahub.alpinebits.validation.schema.v_2020_10.freerooms.UniqueIDValidator();
